...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4789__auto__,writer__4790__auto__,opt__4791__auto__){
return cljs.core._write(writer__4790__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_24846 = (0);
while(true){
if((i_24846 < arr.length)){
(arr[i_24846] = null);

var G__24847 = (i_24846 + (1));
i_24846 = G__24847;
continue;
} else {
}
...
var i_24858 = (self__.level + (1));
while(true){
if((i_24858 <= (new_level + (1)))){
(update[i_24858] = self__.header);
...
var i_24860 = (0);
while(true){
if((i_24860 <= self__.level)){
var links_24861 = (update[i_24860]).forward;
if(((links_24861[i_24860]) === x__$1)){
(links_24861[i_24860] = (x__$1.forward[i_24860]));

var G__24862 = (i_24860 + (1));
i_24860 = G__24862;
continue;
} else {
var G__24863 = (i_24860 + (1));
i_24860 = G__24863;
continue;
}
} else {
...
if(!((nx == null))){
var G__24865 = nx;
var G__24866 = (level__$1 - (1));
x = G__24865;
level__$1 = G__24866;
continue;
} else {
var G__24867 = x;
var G__24868 = (level__$1 - (1));
x = G__24867;
level__$1 = G__24868;
continue;
}
...
var G__24870 = nx;
var G__24871 = (level__$1 - (1));
x = G__24870;
level__$1 = G__24871;
continue;
} else {
var G__24872 = x;
var G__24873 = (level__$1 - (1));
x = G__24872;
level__$1 = G__24873;
continue;
}
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4789__auto__,writer__4790__auto__,opt__4791__auto__){
return cljs.core._write(writer__4790__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
var or__4210__auto__ = (cljs.core.truth_((function (){var and__4198__auto__ = me;
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__4210__auto__,timeout__$1,me){
return (function (){
cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);

return cljs.core.async.impl.protocols.close_BANG_(timeout_channel);
});})(timeout_channel,or__4210__auto__,timeout__$1,me))
,msecs);
